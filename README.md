...
[![Build Real-Time Chat Application with Angular , ASP.NET Core API & Web RTC](https://ytcards.demolab.com/?id=2oEgRs4ICxo&title=Build+Real-Time+Chat+Application+with+Angular+%2C+ASP.NET+Core+API+%26+Web+RTC&lang=en&timestamp=1743153306&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Build Real-Time Chat Application with Angular , ASP.NET Core API & Web RTC")](https://www.youtube.com/watch?v=2oEgRs4ICxo)
<!-- END YOUTUBE-CARDS -->
